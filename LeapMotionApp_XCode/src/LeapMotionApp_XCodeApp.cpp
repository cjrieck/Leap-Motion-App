...
Cubelet::Cubelet(const Vec3f& cntr, const Vec3f& diagonalSize) {
	this->whiteFace = gl::Texture::create( loadImage( loadResource("WhiteFace.PNG") ) );
	this->orangeFace = gl::Texture::create( loadImage( loadResource("OrangeFace.PNG") ) );
	this->greenFace = gl::Texture::create( loadImage( loadResource("GreenFace.PNG") ) );
	this->redFace = gl::Texture::create( loadImage( loadResource("RedFace.PNG") ) );
	this->blueFace = gl::Texture::create( loadImage( loadResource("BlueFace.PNG") ) );
	this->yellowFace = gl::Texture::create( loadImage( loadResource("YellowFace.PNG") ) );
